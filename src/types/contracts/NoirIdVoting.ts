...
export interface NoirIdVotingInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: 'proposalsState', values?: undefined): string
  ...
  decodeFunctionResult(functionFragment: 'proposalsState', data: BytesLike): Result
...
export interface NoirIdVoting extends BaseContract {
  ...
  getFunction(nameOrSignature: 'proposalsState'): TypedContractMethod<[], [string], 'view'>
